...
- `infra/k8s` for cluster workloads, routing objects, runtime controls, and observability resources
...
- `infra/k8s` is the source for in-cluster services, routing, scheduling, and policies
